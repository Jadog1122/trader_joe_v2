          ...
          {allNavItems.map((item, index) => {
            if (item.isCamera) {
              ...
              return (
                <div key="camera" className="flex justify-center">
                  <button className="group relative flex flex-col items-center py-2 haptic-feedback">
                    <div className="w-14 h-14 bg-gradient-to-br from-[#D32F2F] to-[#B22222] rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-102 group-active:scale-98 transition-all duration-200 hover:shadow-xl">
            ...
            return (
              <button
                ...
                className="flex flex-col items-center justify-center gap-1 py-2 px-2 hover:opacity-80 transition-all duration-200 relative haptic-feedback hover:scale-102 active:scale-98"
              >
                {item.notification && (
                ...
                <IconComponent 
                  className={`w-6 h-6 transition-all duration-200 ${
                    item.active 
                      ...
                      : 'text-gray-500 hover:text-[#D32F2F]'
                  }`}
                />
                <span 
